...
if (typeof firebase === 'undefined') {
    console.error('Service Worker: Firebase failed to load');
    // Don't throw an error; let the Service Worker continue
}
...
try {
    ...
    // Don't throw the error; let the Service Worker continue
}
